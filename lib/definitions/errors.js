...
export function EINVALIDCFASECRET() {
  return {
    message: 'Missing CFA_SECRET environment variable',
    details: '',
  };
}

export function EINVALIDCFAPROJECTID() {
  return {
    message: 'Missing CFA_PROJECT_ID environment variable',
    details: '',
  };
}
